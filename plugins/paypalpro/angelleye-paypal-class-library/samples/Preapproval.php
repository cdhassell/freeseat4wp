...
$PreapprovalFields = array(
						   'CancelURL' => $domain.'cancel.php',  								// Required.  URL to send the browser to after the user cancels.
						   ...
						   'StartingDate' => '2013-08-21', 							// Required.  First date for which the preapproval is valid.  Cannot be before today's date or after the ending date.
